...
CPPS += $(ROOTPATH)/test/ComplexToReal.cpp $(ROOTPATH)/test/RealToComplex.cpp $(ROOTPATH)/test/TestCFR2BlindDecon2D.cpp $(ROOTPATH)/test/TestCFR2BlindDeconvolution.cpp $(ROOTPATH)/test/TestCSO.cpp $(ROOTPATH)/test/TestCSOPhaseRetrieval.cpp $(ROOTPATH)/test/TestElasticCurvesRO.cpp $(ROOTPATH)/test/TestEucBlindDeconvolution.cpp $(ROOTPATH)/test/TestEucFrechetMean.cpp $(ROOTPATH)/test/TestEucPosSpCd.cpp $(ROOTPATH)/test/TestEucQuadratic.cpp $(ROOTPATH)/test/TestGrassRQ.cpp $(ROOTPATH)/test/TestKarcherMean.cpp $(ROOTPATH)/test/TestLRBlindDeconvolution.cpp $(ROOTPATH)/test/TestLRMatrixCompletion.cpp $(ROOTPATH)/test/TestMyMatrix.cpp $(ROOTPATH)/test/TestOrthBoundingBox.cpp $(ROOTPATH)/test/TestPreShapePathStraighten.cpp $(ROOTPATH)/test/TestProduct.cpp $(ROOTPATH)/test/TestSPDMean.cpp $(ROOTPATH)/test/TestSPDTensorDL.cpp $(ROOTPATH)/test/TestShapePathStraighten.cpp $(ROOTPATH)/test/TestSparsePCA.cpp $(ROOTPATH)/test/TestSphereRayQuo.cpp $(ROOTPATH)/test/TestSphereSparsestVector.cpp $(ROOTPATH)/test/TestStieBrockett.cpp $(ROOTPATH)/test/TestStieSoftICA.cpp $(ROOTPATH)/test/TestStieSparseBrockett.cpp $(ROOTPATH)/test/TestTestSparsePCA.cpp $(ROOTPATH)/test/TestWeightedLowRank.cpp 
# CPPS += $(ROOTPATH)/test/TestProductExample.cpp $(ROOTPATH)/test/TestSimpleExample.cpp # in case multiple definition of main()
